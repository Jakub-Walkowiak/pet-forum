...
export const BlogPostAddValidator = z.object({
...
export const BlogPostFetchValidator = z.object({
...
export const BlogTagFetchValidator = z.object({
    limit: z.coerce.number().max(100).default(25),
    offset: z.coerce.number().default(0),
...
export const BlogTagAddValidator = z.object({
