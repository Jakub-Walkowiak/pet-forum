...
export const PetAddValidator = z.object({
...
export const PetEditValidator = z.object({
...
export const PetFetchValidator = z.object({
...
export const OwnerAddValidator = z.object({
    user: z.coerce.number(),
})

export const PetTypeFetchValidator = z.object({
    limit: z.coerce.number().max(100).default(25),
    offset: z.coerce.number().default(0),
    nameQuery: z.string().trim().optional(),
...
export const PetTypeAddValidator = z.object({
    name: z.string().trim().min(1).max(50),
})
