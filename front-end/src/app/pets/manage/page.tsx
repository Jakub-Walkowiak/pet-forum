...
export default function Page() {
  ...
  if (auth)
      ...
      <>
        <div className='w-full h-14 flex items-center justify-between border-b border-zinc-700 py-10 px-10'>
          ...
          <div className='flex text-xl'>
            <Button text='Add pet' onClickHandler={() => showModal(<CreatePetForm />)} />
          </div>
        </div>
    ...
    return <div className='w-full h-full flex items-center justify-center text-4xl font-bold'>Log in to add pets!</div>
}
