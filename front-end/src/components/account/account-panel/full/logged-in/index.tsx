...
export default function LoggedIn({ authId }: LoggedInProps) {
    ...
    if (profileData !== undefined) return (
        <div className={`z-10 flex duration-200 cursor-pointer gap-4 p-4 m-2 items-center h-fit hover:bg-gray-800 relative ${showPopup ? 'bg-gray-800 rounded-b-lg' : 'rounded-lg'}`} 
