...
export default function PanelPopup({ show }: PanelPopupProps) {
  ...
  return (
    <div
      className={`-z-10 duration-200 h-full cursor-auto absolute left-0 top-0 p-1 flex flex-col w-full bg-gray-800/30 rounded-t-lg text-xl ${show ? '-translate-y-full opacity-1 pointer-events-auto' : 'translate-y-0 opacity-0 pointer-events-none'}`}
