        ...
        <>
          <div className='flex gap-4 items-center'>
            ...
            <div className='flex items-center'>
              <PetLabel size='large' text={data.name} id={id} />
            </div>
          </div>
          <div className='flex flex-col gap-4'>
            {allowRescindButton && data.owned && (
              <div className='flex-0 inset-y-0 my-auto'>
                <PetRescindButton id={id} soleOwner={data.owners.length === 1} />
              </div>
            )}
            <div className='flex-0 inset-y-0 my-auto'>
              <PetFollowButton id={id} followed={data.followed} owned={data.owned} />
            </div>
          </div>
        </>
      )}
