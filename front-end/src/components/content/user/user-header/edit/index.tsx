          ...
          <form className='w-full' onSubmit={handleSubmit(async (data) => await onSubmit(images, data))}>
            ...
            <div className='w-full relative flex p-2 gap-2'>
              <div className='bg-emerald-500 rounded-full p-1 relative -top-12 flex-shrink-0 w-fit h-fit'>
                ...
                />
                <div className='hover:opacity-75 cursor-pointer duration-200'>
              ...
              <div className='flex flex-col'>
                ...
                />
                <div onClick={handleAccountNameClick} className='*:pointer-events-none'>
              ...
              <div className='absolute top-36 left-3'>
                <Button text='Save' className='w-40 h-10' />
              </div>
            </div>
            ...
            <div className='flex px-3 py-4 items-end gap-3'>
              ...
              {showStats ? (
                <AiFillInfoCircle
                  className='text-xl inset-y-0 my-auto cursor-pointer hover:text-gray-500 duration-200 me-3'
              ...
              <TogglableWrapper
                innerRenderer={(visible) => (
                  <span className={`${visible ? 'font-semibold' : 'font-normal'} text-lg`}>
                    Likes {visible ? 'shown' : 'hidden'}
                  </span>
                )}
