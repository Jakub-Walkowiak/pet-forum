...
import patchPassword, { PatchPasswordInputsValidator, PatchPasswwordInputs } from "@/helpers/fetch-helpers/account/patch-password"
...
export default function ChangePasswordForm() {
    ...
    return (
        <form className="flex flex-col gap-4 py-4 flex-wrap w-fit" onSubmit={handleSubmit(async data => await onSubmit(data))}>
