    ...
    return (
        <div className="flex flex-col justify-between fixed inset-0 m-auto w-96 h-fit z-20 bg-gray-900 rounded-lg p-4">
            ...
            <div className="flex gap-4 w-full">
                <div className="flex-1"><Button className="w-full" text={confirmText ? confirmText : 'Confirm'} onClickHandler={handleConfirm}/></div>
                <div className="flex-1"><Button className="w-full" text="Cancel" onClickHandler={handleCancel} dark/></div>
            </div>
        </div>
    )
} 